...
public class ResultDelegate implements PayPalResultDelegate, Serializable {
    ...
    public void onPaymentSucceeded(String payKey, String paymentStatus) {
        PaymentActivity.showToast(R.string.paypal_success);
    }
    ...
    public void onPaymentFailed(String paymentStatus, String correlationID,
        ...
        if(paymentStatus!=null){
            Log.e("PAYPAL FAILURE",paymentStatus);

        } if(correlationID!=null){
            Log.e("PAYPAL FAILURE",correlationID);

        } if(payKey!=null){
            Log.e("PAYPAL FAILURE",payKey);

        } if(errorID!=null){
            Log.e("PAYPAL FAILURE",errorID);

        } if(errorMessage!=null){
            Log.e("PAYPAL FAILURE",errorMessage);
        }
        PaymentActivity.showToast(R.string.paypal_failed);
    }
    ...
    public void onPaymentCanceled(String paymentStatus) {
        PaymentActivity.showToast(R.string.paypal_canceled);
    }
}
